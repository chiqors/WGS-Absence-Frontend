...
const PaginatedErrorLog = ({ data }) => {
  ...
  const fetchLogs = async (pag, lim, ser) => {
    const response = await logApi.getAllErrorLog(pag, lim, ser);
    return response;
  };
  ...
  return (
    <>
      <div className="flex justify-between mb-4">
        {/* this will contain table name and description */}
        <div className="flex flex-col">
          <h2 className="text-lg font-semibold text-gray-700">Error Logs</h2>
          <p className="text-sm text-gray-600">List of all error logs</p>
        </div>
      </div>
      <div className="flex justify-between mb-4">
